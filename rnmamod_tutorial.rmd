...
Looking at the last two table, we notice sno material difference between the network meta-analysis and the unrelated effects model, and hence, the message in red at the start of the console that **There is little to choose between the two models.** Therefore, consistency may hold globally.
...
The leverage plot under the network meta-analysis (left) and the unrelated mean effects model (right):
