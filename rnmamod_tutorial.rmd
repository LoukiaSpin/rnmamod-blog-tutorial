...
completers. IMOR equal to 1 coincides with the MAR mechanism, and IMOR different 
from 1 implies the MNAR mechanism. We have considered a different IMOR distribution 
for each intervention: the first intervention is assumed to have on average twice 
the odds of an event in completers than that in missing participants (the mode), 
with other scenarios being less and less likely to occur as we deviate from the 
mode. On the contrary, the second intervention is assumed to have on average twice 
...
```{r imor, echo=FALSE, out.width = "50%", out.height = "15%", fig.align="center", fig.cap = "Figure 4: The IMOR parameter under different scenarios for each intervention", fig.alt=""}
