...
On the console you see will two sets of progress bars: the first one shows the progress of the simulation. Once the model completes the iterations for all chains, a second progress bar will appear on the console that shows the progress of the model update for `n_iter = 10000` iterations until convergence:
