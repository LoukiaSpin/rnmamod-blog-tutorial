...
This approach boils down to comparing the network meta-analysis model with a series of pairwise meta-analyses that share a common heterogeneity parameter. The models are, then, compared regarding a set of goodness of fit measuress and relevant diagnostic plots. Let's dive in to two functions: `run_ume` and `ume_plot`. 
