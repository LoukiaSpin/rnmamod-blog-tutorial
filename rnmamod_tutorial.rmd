...
* the rich visualisation toolkit of the rnmamod R package that aims to assist you in critically
appraising your results.

The minimum required knowledge to benefit from the tutorial includes being familiar
with:
...
R packages for pairwise and network meta-analysis. Since then (2 years ago), one 
thing led to another and we ended up expanding our goals to set-up a comprehensive 
